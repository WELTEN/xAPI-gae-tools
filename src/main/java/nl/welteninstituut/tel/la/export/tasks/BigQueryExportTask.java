 ...
 */
package nl.welteninstituut.tel.la.export.tasks;
 ...
 * 
 */
public class BigQueryExportTask extends GenericBean {
    ...
    private static final Logger log = Logger.getLogger(BigQueryExportTask.class.getName());
