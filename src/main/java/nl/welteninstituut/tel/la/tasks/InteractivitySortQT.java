 ...
 * ****************************************************************************
 */
public class InteractivitySortQT extends GenericBean {
    private String jobId;
    private String cacheKey;

    public InteractivitySortQT() {

    }
    public InteractivitySortQT(String jobId, String cacheKey) {
        this.jobId = jobId;
            ...
            if (pollJob.getStatus().getState().equals(Common.DONE)) {
                ...
                if (rows !=null)
                    for (TableRow row : rows) {
                        ...
                        String count = ((TableCell) rowList.get(0)).getV()+"";
