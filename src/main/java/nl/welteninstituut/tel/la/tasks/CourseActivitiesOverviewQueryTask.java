 ...
 * ****************************************************************************
 */
public class CourseActivitiesOverviewQueryTask extends GenericBean {
    private String jobId;
    private String courseId;

    public CourseActivitiesOverviewQueryTask() {

    }
    public CourseActivitiesOverviewQueryTask(String jobId, String courseId) {
        this.jobId = jobId;
    ...
    public void run() {
        ...
        try {
            ...
            if (pollJob.getStatus().getState().equals("DONE")) {
                ...
                QueryCacheManager.addQueryResult("course_activities_"+courseId, learnerAverageActivities.toJsonObject().toString());
            } else {
                scheduleTask();
            }
        } catch (IOException e) {
