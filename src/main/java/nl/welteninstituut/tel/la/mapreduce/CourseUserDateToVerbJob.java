...
import nl.welteninstituut.tel.la.jdo.CourseUserDateToVerb;
 ...
 * ****************************************************************************
 */
public class CourseUserDateToVerbJob extends Job {
    ...
    public CourseUserDateToVerbJob(long date) {
        this.date =date;
    }
...
//        Output<KeyValue<String, UserDateVerb>, Void> output = new CalendarOutput(); //O R
        ...
        public void map(Entity entity) {
            try {
                ...
                if (timestampLong > date) {
                    ...
                    Entity entityOut = new Entity(KeyFactory.createKey(CourseUserDateToVerb.TABLE_NAME, key));
                    entityOut.setProperty(CourseUserDateToVerb.VALUE_COLUMN, new Text(userDateVerb.toJson().toString()));
                    entityOut.setProperty(CourseUserDateToVerb.ACTORID_COLUMN, actorId);
                    entityOut.setProperty(CourseUserDateToVerb.COURSEID_COLUMN, courseId);
                    emit(key, entityOut);
    ...
    class CalendarReducer extends Reducer<String, Entity,  Entity> { //K V O
        ...
        public void reduce(String actorIdDate, ReducerInput<Entity> reducerInput) { //K  ReducerInput<V>
            ...
            resultEntity.setProperty(CourseUserDateToVerb.VALUE_COLUMN, new Text(resultUserDateVerb.toJson().toString()));
